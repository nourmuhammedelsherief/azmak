                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('restaurant.whatsapp.order_seller_codes.index')}}">
            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('restaurant.whatsapp.order_seller_codes.update' , $code->id)}}" method="post"
