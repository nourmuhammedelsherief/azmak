...
@section('title')
    @lang('messages.edit') @lang('dashboard.online_offer_images')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('dashboard.online_offer_images') </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{ route('restaurant.online_offer.image.index') }}">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('dashboard.online_offer_images') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{ route('restaurant.online_offer.image.update' , $item->id) }}"
                            method="post" enctype="multipart/form-data">
                            <input type='hidden' name='_token' value='{{ Session::token() }}'>
                            @method('put')
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="control-label"> @lang('dashboard.online_offer_categories') *</label>
                                    <select name="category_id"  class="form-control" value="{{ old('category_id') }}"
                                        placeholder="@lang('dashboard.entry.category_id')">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" type="status" class="form-control" value="{{ old('status') }}"
                                        placeholder="@lang('dashboard.entry.status')">
                                ...
                                <div class="form-group ">
                                    <label class="control-label col-md-3">
                                        {{ app()->getLocale() == 'ar' ? 'صورة ' : ' Image' }} </label>
                                    <div class="col-md-9">
                    ...
                    $("#post-form").validate({
                        ...
                        messages: {
                            ...
                            price: {
                                ...
                                maxlength: "{{ trans('messages.max_length') }}" + " " + "{{ trans('messages.price') }}" +
                                    "8",
                            },
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                url: "{{ route('restaurant.online_offer.image.store') }}",
                                type: "POST",
