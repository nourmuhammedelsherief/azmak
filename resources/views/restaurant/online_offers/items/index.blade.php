...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.online_offer_categories')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{ route('restaurant.online_offer.category.index') }}"></a>
                            @lang('dashboard.online_offer_categories')
                        </li>
                    </ol>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <h3>
                    ...
                    <a href="{{ route('restaurant.online_offer.category.create') }}" class="btn btn-info">
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a class="btn btn-info"
                                                href="{{ route('restaurant.online_offer.category.edit', $item->id) }}">
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" +
                        "/restaurant/online_offer/category/delete/" + id;
