...
@section('title')
    @lang('messages.add') @lang('dashboard.online_offer_categories')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('dashboard.online_offer_categories') </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('restaurant.online_offer.category.index')}}">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('dashboard.online_offer_categories') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('restaurant.online_offer.category.store')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" type="status" class="form-control"
                                           value="{{old('status')}}" placeholder="@lang('dashboard.entry.status')">
                                           <option value="true" {{old('status') == 'true' ? 'selected' : '' }}>{{ trans('dashboard.yes') }}</option>
                                           <option value="false" {{old('status') == 'false' ? 'selected' : '' }}>{{ trans('dashboard.no') }}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="sort" type="number" class="form-control"
                                           value="{{old('sort') ?? '1'}}" placeholder="@lang('dashboard.entry.sort')">
                                    @if ($errors->has('sort'))
                                        <span class="help-block">
                ...
                if ($("#post-form").length > 0) {
                    $("#post-form").validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            $.ajax({
                                url: "{{ route('restaurant.online_offer.category.store') }}",
                                type: "POST",
