                                ...
                                <div id="DeliveryCheck"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="minimum_delivery" type="radio"
                                               ...
                                               {{$branch->minimum_delivery == 'true' ? 'checked': ''}}
                                        ...
                                        <input name="minimum_delivery"
                                               ...
                                               {{$branch->minimum_delivery == 'false' ? 'checked': ''}}
                                    ...
                                    <div id="minimum_delivery_div" style="display: {{$branch->minimum_delivery == 'true' ? 'block' : 'none'}}">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <input name="minimum_delivery_value" type="number"
                                                           class="form-control"
                                                           value="{{$branch->minimum_delivery_value}}"
