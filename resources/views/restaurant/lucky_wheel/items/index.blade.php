...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.lucky_wheel_items')</h1>
                </div>
                <!--<div class="col-sm-6">-->
                ...
                <!--            <a href="{{ route('restaurant.lucky.item.index') }}"></a>-->
                <!--            @lang('dashboard.lucky_wheel_items')-->
                <!--        </li>-->
                <!--    </ol>-->
                <!--</div>-->
        ...
        <div class="row">
            <div class="col-12">
                <h3>
                    ...
                    <a href="{{ route('restaurant.lucky.item.create') }}" class="btn">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <p class="alert alert-secondary"><span class="badge badge-warning">{{ trans('dashboard.note') }} : </span> {{ trans('dashboard.lucky_items_notes') }}</p>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a class="btn btn-primary"
                                                href="{{ route('restaurant.lucky.item.edit', $item->id) }}">
            ...
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" +
                        "/restaurant/lucky_wheel/item/delete/" + id;
