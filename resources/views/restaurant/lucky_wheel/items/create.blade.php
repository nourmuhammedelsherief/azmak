...
@section('title')
    @lang('messages.add') @lang('dashboard.lucky_wheel_items')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('dashboard.lucky_wheel_items') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('dashboard.lucky_wheel_items') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('restaurant.lucky.item.store')}}" method="post"
                ...
                if ($("#post-form").length > 0) {
                    $("#post-form").validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            $.ajax({
                                url: "{{ route('restaurant.lucky.item.store') }}",
                                type: "POST",
