                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th> @lang('dashboard.foodics_order_reference') </th>
                            ...
                            <tbody>
                                ...
                                @foreach ($orders as $order)
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            @if (!empty($order->foodics_status))
                                               {!! $order->getFoodicsStatusHtml2() !!}
                                            @endif
                                        </td>
                                        <td>
