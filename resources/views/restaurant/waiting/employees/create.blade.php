...
@section('title')
    @lang('messages.add') @lang('dashboard.waiting_employee')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('dashboard.waiting_employee') </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('restaurant.waiting.employee.index')}}">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('dashboard.waiting_employee') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('restaurant.waiting.employee.store')}}" method="post"
                ...
                if ($("#post-form").length > 0) {
                    $("#post-form").validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            $.ajax({
                                url: "{{ route('restaurant.waiting.employee.store') }}",
                                type: "POST",
