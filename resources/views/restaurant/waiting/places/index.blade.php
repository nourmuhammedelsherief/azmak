...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.waiting_places')</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('restaurant.waiting.place.create')}}" class="btn btn-info">
                            ...
                            @foreach($places as $index => $item)
                                <tr class="odd gradeX">
                                    ...
                                    <td style="text-align: center;">
                                        {{$item->orders()->where('status' , 'new')->count()}}
                                    </td>
                                    <td>
                                        @if($item->status == true)
                                    ...
                                    <td>
                                        <a href="{{route('restaurant.waiting.place.edit' , $item->id)}}"
        ...
        $(document).ready(function () {
            $('body').on('click', '.delete_data', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/restaurant/waiting/place/delete/" + id;
