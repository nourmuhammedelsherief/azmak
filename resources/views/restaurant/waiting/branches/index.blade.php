...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('restaurant.waiting.branch.create')}}" class="btn btn-info">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($branches as $index => $item)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="{{route('restaurant.waiting.branch.edit' , $item->id)}}"
        ...
        $(document).ready(function () {
            $('body').on('click', '.delete_data', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/restaurant/waiting/branch/delete/" + id;
