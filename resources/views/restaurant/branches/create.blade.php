                        ...
                        <form role="form" action="{{route('branches.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name_en" onkeypress="clsAlphaNoOnly(event)" onpaste="return false;"  type="text" class="form-control" value="{{old('name_en')}}" placeholder="@lang('messages.name_en') [format :  A-Za-z]" required>
