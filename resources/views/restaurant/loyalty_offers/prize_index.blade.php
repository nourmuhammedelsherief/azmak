...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.loyalty_prizes')</h1>
                </div>
                <!--<div class="col-sm-6">-->
                        ...
                        <table id="example1" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th> @lang('dashboard.cacher_name') </th>
                                ...
                                @foreach ($items as $item)
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="text-center">
                                            @if($item->status == 'completed')
                                                <p class="badge badge-info">{{$item->cacher_name}}</p>
                                                <br>
                                                <span>{{date('Y-m-d h:i A' , strtotime($item->delivery_date))}}</span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @if ($item->status == 'new')
                                                <a class=" btn btn-primary send-prize" data-id="{{ $item->id }}"
                                                    style="color:white ;"
                                                    data-toggle="modal" data-target="#exampleModal">
                                                    {{ trans('dashboard.send_prize') }}
                                                </a>
                                            @endif
