            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('restaurant.loyalty-offer.item.store')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="required_quantity" type="number" class="form-control"
                                           value="{{old('required_quantity') ?? '1'}}" placeholder="@lang('dashboard.required_quantity_to_prize')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="prize" type="text" class="form-control"
                                           value="{{old('prize')}}" placeholder="@lang('dashboard.prize')">
                                    @if ($errors->has('prize'))
                                        <span class="help-block">
