...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('styles/style1.css')}}">
    @if(app()->getLocale() == 'en')
    <link rel="stylesheet" type="text/css" href="{{asset('styles/style_ltr.css')}}">
    @endif
    <link rel="stylesheet" type="text/css" href="{{asset('styles/global2.css')}}">
...
@if($restaurant != null)
    <body class="theme-light" data-highlight="yellow2" dir="{{app()->getLocale() == 'ar' ? 'rtl' : 'ltr'}}" style="max-width: 1000px; margin:auto; background-color: {{$restaurant->color == null ? '' : $restaurant->color->background}};">
@else
